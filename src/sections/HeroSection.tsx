            ...
            <IPhoneMockup>
              <div className={`h-full flex flex-col transition-colors duration-300 ${dark ? "bg-gray-900 text-white" : "bg-white text-gray-900"}`}>
                ...
                <div className="pt-10 px-4 pb-2">
                  ...
                  {/* Interactive Time Range Selector (New) */}
                  <div className={`flex justify-between px-1 py-1 rounded-lg mb-2 ${dark ? 'bg-gray-800' : 'bg-gray-100'}`} onClick={(e) => e.stopPropagation()}>
                  ...
                  {/* Mini sparkline */}
                  <svg viewBox="0 0 120 24" className="w-full h-8 mb-1">
                    <polyline
                ...
                {/* Holdings List */}
                <div className="flex-1 px-4 overflow-hidden mt-2">
                  {viewMode === "detailed" ? (
                ...
                {/* Bottom tab bar - Upgraded to Professional Icons */}
                <div className={`flex justify-between px-4 pb-5 pt-3 border-t ${dark ? 'border-gray-800 bg-gray-900/90' : 'border-gray-100 bg-white/90'} backdrop-blur-md`}>
                  {[
